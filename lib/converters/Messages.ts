...
export const limitedMessagesRef = (chatId: string, limitTo: number = 25) =>
  query(messagesRef(chatId), limit(limitTo)).withConverter(messageConverter);

export const orderedMessagesRef = (chatId: string) =>
